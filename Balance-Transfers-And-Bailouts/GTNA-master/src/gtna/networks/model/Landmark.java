 ...
 *
 */
public class Landmark extends Network {
     ...
     */
    public static Landmark[] get(int[] n, Transformation[] t) {
	Landmark[] nw = new Landmark[n.length];
	
	for(int i = 0; i < n.length; i++) {
	    nw[i] = new Landmark(n[i], t);
	}
     ...
     */
    public Landmark(int nodes, Transformation[] t) {
	super("BAILOUT", nodes, null, t);
